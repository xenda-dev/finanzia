...
function openProfilePage(){
  ...
  overlay.style.cssText='position:fixed;inset:0;z-index:200;background:var(--surface);display:flex;flex-direction:column;overflow:hidden';
  var header=
    '<div style="background:linear-gradient(160deg,rgba(0,212,170,.10),rgba(116,97,239,.06));padding:10px 12px 0;flex-shrink:0">'
    +'<div style="display:flex;align-items:center;gap:8px">'
    ...
    +'</div>'
    +'</div>'
    +'<div style="background:var(--surface);height:26px;border-radius:24px 24px 0 0;margin-top:12px;position:relative;z-index:1;flex-shrink:0"></div>';
