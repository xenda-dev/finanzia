...
function renderConfiguracion(){
  ...
  var secLbl=function(txt,first){return '<div style="font-size:10px;font-weight:700;color:var(--text3);text-transform:uppercase;letter-spacing:1px;margin:'+(first?'6px 0 10px':'22px 0 8px')+';padding-left:2px">'+txt+'</div>';};
