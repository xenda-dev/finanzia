...
var _fpSvgLg = '<svg width="72" height="72" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M50 58 C48 54 48 48 50 44 C52 48 52 54 50 58Z" stroke="#00D4AA" stroke-width="2.2" stroke-linecap="round"/><path d="M44 62 C38 56 38 44 44 38 C47 34 53 34 56 38 C62 44 62 56 56 62" stroke="#00D4AA" stroke-width="2.2" stroke-linecap="round" fill="none"/><path d="M37 67 C28 60 26 44 33 35 C38 28 62 28 67 35 C74 44 72 60 63 67" stroke="#00D4AA" stroke-width="2.2" stroke-linecap="round" fill="none"/><path d="M30 72 C18 63 15 44 23 32 C30 22 70 22 77 32 C85 44 82 63 70 72" stroke="#00D4AA" stroke-width="2.2" stroke-linecap="round" fill="none"/><path d="M22 76 C8 65 5 43 14 28 C23 14 77 14 86 28 C95 43 92 65 78 76" stroke="#00D4AA" stroke-width="2" stroke-linecap="round" fill="none" opacity=".6"/><path d="M22 76 C18 80 16 85 17 90" stroke="#00D4AA" stroke-width="2" stroke-linecap="round" opacity=".5"/><path d="M78 76 C82 80 84 85 83 90" stroke="#00D4AA" stroke-width="2" stroke-linecap="round" opacity=".5"/></svg>';
var _fpSvgSm = '<svg width="28" height="28" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" style="pointer-events:none"><path d="M50 58 C48 54 48 48 50 44 C52 48 52 54 50 58Z" stroke="currentColor" stroke-width="3" stroke-linecap="round"/><path d="M44 62 C38 56 38 44 44 38 C47 34 53 34 56 38 C62 44 62 56 56 62" stroke="currentColor" stroke-width="3" stroke-linecap="round" fill="none"/><path d="M37 67 C28 60 26 44 33 35 C38 28 62 28 67 35 C74 44 72 60 63 67" stroke="currentColor" stroke-width="3" stroke-linecap="round" fill="none"/><path d="M30 72 C18 63 15 44 23 32 C30 22 70 22 77 32 C85 44 82 63 70 72" stroke="currentColor" stroke-width="3" stroke-linecap="round" fill="none"/><path d="M22 76 C8 65 5 43 14 28 C23 14 77 14 86 28 C95 43 92 65 78 76" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" fill="none" opacity=".6"/></svg>';
